...
if __name__ == '__main__':
    T       = 500 
    W = 2.
    distribution = 'truncated_gaussian' # truncate iid zero-mean identity-covariance Gaussian to -W and W
    savedir = 'ICML_camera_loose_gaussian'
    variance_scale = compute_truncGaussian_variance(alpha=-W, beta=W, sig=1.)
